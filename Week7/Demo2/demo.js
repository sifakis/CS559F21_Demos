function setup() {
	...
	function draw3DAxes(color,Tx) {
	    ...
	    // X-label
	    moveToTx([1.3,0,0],Tx);lineToTx([1.4,.1,0],Tx);
	    moveToTx([1.3,.1,0],Tx);lineToTx([1.4,0,0],Tx);
            // Y-label
            moveToTx([0,1.35,0],Tx);lineToTx([.05,1.3,0],Tx);lineToTx([.1,1.35,0],Tx);
            moveToTx([.05,1.3,0],Tx);lineToTx([.05,1.23,0],Tx);
